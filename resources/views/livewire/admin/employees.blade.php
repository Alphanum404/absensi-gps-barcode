<div>
  <div class="mb-4 flex-col items-center gap-5 sm:flex-row md:flex md:justify-between lg:mr-4">
    ...
    <x-button wire:click="showCreating">
      <x-heroicon-o-plus class="mr-2 h-4 w-4" /> Tambah Anggota
    </x-button>
  </div>
  ...
  <x-dialog-modal wire:model="creating">
    ...
    @endif
        <div class="mt-4">
          <x-label for="name">Nama Anggota</x-label>
      ...
      @enderror
          ...
          <div class="w-full">
            ...
            <x-input id="nim" class="mt-1 block w-full" type="text" wire:model="form.nim" placeholder="12345678"
              required />
            @error('form.nim')
      ...
      @enderror
        ...
        <div class="w-full">
          <x-label for="education_id">Kelas</x-label>
          <x-select id="education_id" class="mt-1 block w-full" wire:model="form.education_id">
            <option value="">{{ __('Select Mayor') }}</option>
