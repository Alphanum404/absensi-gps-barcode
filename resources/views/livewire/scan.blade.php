<div class="w-full">
  ...
  @endif
    ...
    @else
      <div
        class="flex flex-col-reverse items-center justify-center gap-2 rounded-md bg-gray-400 px-4 py-2 text-center font-medium text-white shadow-md shadow-gray-400 cursor-not-allowed dark:shadow-gray-700 md:flex-row md:gap-3">
        Ajukan Izin (Tidak ada event)
        <x-heroicon-o-envelope-open class="h-6 w-6 text-white" />
      </div>
    @endif
...
<script>
  ...
  if (!$wire.isAbsence) {
    ...
    const msg = 'Pilih event terlebih dahulu';
